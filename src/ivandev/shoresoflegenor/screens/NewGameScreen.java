...
import ivandev.shoresoflegenor.entities.units.TankUnit;
import ivandev.shoresoflegenor.generators.NameStringGen;
import ivandev.shoresoflegenor.generators.TerrainPreset;
import ivandev.shoresoflegenor.generators.TerrainPreset.MapPreset;
import ivandev.shoresoflegenor.maps.WorldMap;
import ivandev.shoresoflegenor.player.BotPlayer;
import ivandev.shoresoflegenor.player.BotPlayer.BotDifficulty;
import ivandev.shoresoflegenor.player.GamePlayer;
import ivandev.shoresoflegenor.tiles.AbstractMapTile;
import ivandev.shoresoflegenor.util.InputUtil;
